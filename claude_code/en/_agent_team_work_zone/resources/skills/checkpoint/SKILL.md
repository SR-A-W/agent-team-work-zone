...
- Write path: `_agent_team_work_zone/<team_name>/teammates/<self_name>/working-context.md`. Know your team_name and name from conversation context (they were in the spawn prompt; do not rely on environment variables).
